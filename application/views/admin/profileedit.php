  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="card ">
        ...
        <form class="form-valide" action="<?php echo base_url()?>admin/profile/profileupdate" method="post" enctype="multipart/form-data">
                  <div class="row mb-3">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Full Name</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      <input type="hidden" name="id" id="id" value="<?php echo $admin_details->id?>">
                      <input type="text" class="form-control" name="fullname" id="name" value="<?php echo $admin_details->fullname;?>">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" class="form-control" name="bio" id="bio" value="<?php echo $admin_details->bio;?>">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" class="form-control" name="mobilenumber" id="mobilenumber" value="<?php echo $admin_details->mobilenumber;?>">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" class="form-control" name="address" id="address" value="<?php echo $admin_details->address;?>">
                    </div>
                  </div>
                  <div class="row">
